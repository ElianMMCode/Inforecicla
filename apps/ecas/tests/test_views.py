...
from config.constants import TipoUsuario, TipoDocumento, Visibilidad
from django.contrib.auth.models import User
from apps.users.models import Usuario, UsuarioManager
...
class TestRegistroPuntoECA(TestCase):
    ...
    def test_editar_perfil_gestor_get(self):
        ...
        if response.status_code == 500:
            ...
            raise Exception(f"🚨 ERROR REAL DESCUBIERTO:\n\n{html_error[:1500]}")
    ...
    def test_registro_punto_eca_post_valid(self):
        ...
        if response.status_code != 302:
            ...
            raise Exception(f"🚨 EL FORMULARIO REBOTÓ. ERRORES: {errores}")
