...
# Limites y formatos para Publicaciones
PUBLICACION_TITULO_MAX_LENGTH = 255
PUBLICACION_CONTENIDO_MAX_LENGTH = 10000
PUBLICACION_VIDEO_ALLOWED_EXTENSIONS = ("mp4", "webm", "ogg")
PUBLICACION_VIDEO_ALLOWED_MIME_TYPES = ("video/mp4", "video/webm", "video/ogg")
PUBLICACION_VIDEO_MAX_SIZE = 100 * 1024 * 1024
PUBLICACION_IMAGE_MAX_SIZE = 6 * 1024 * 1024
PUBLICACION_IMAGE_ALLOWED_MIME_TYPES = ("image/jpeg", "image/png", "image/webp")
