...
Este documento detalla los casos de prueba diseñados para cubrir exhaustivamente las funcionalidades derivadas del CU-10: "Exportar Historial de Operaciones", incluyendo validaciones adicionales como excepciones y uso eficiente de recursos.
...
historial de operaciones en InfoRecicla. Asegúrese de preparar los datos iniciales
