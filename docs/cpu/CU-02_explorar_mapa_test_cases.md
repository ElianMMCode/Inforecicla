...
| **Módulo de Django a Testear** | `locations/static/js/map_logic.js` (Frontend integration), `locations/views.py`                                                                                                                                    |
...
| **Módulo de Django a Testear** | `locations/templates/map.html`                                                                                                                                           |
...
| **Módulo de Django a Testear** | `locations/views.py`, `locations/models.py`                                                                                                                                          |
...
| **Módulo de Django a Testear** | `locations/views.py`                                                                                                                  |
...
| **Módulo de Django a Testear** | `locations/static/js/map_logic.js`                                                                                                                  |
...
| ID del Test                    | TC-EXT06-01: Notificar 'Sin Resultados / Fuera de Rango'                                                                                                                  |
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Descripción / Objetivo**     | Verificar la respuesta cuando no existen puntos ECA en el área consultada o con los filtros aplicados.                                                                     |
